...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  \*****************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    var settle = __webpack_require__(
                        /*! ./../core/settle */ "./lib/core/settle.js"
                    );
                    var cookies = __webpack_require__(
                        /*! ./../helpers/cookies */ "./lib/helpers/cookies.js"
                    );
                    var buildURL = __webpack_require__(
                        /*! ./../helpers/buildURL */ "./lib/helpers/buildURL.js"
                    );
                    var buildFullPath = __webpack_require__(
                        /*! ../core/buildFullPath */ "./lib/core/buildFullPath.js"
                    );
                    var parseHeaders = __webpack_require__(
                        /*! ./../helpers/parseHeaders */ "./lib/helpers/parseHeaders.js"
                    );
                    var isURLSameOrigin = __webpack_require__(
                        /*! ./../helpers/isURLSameOrigin */ "./lib/helpers/isURLSameOrigin.js"
                    );
                    var createError = __webpack_require__(
                        /*! ../core/createError */ "./lib/core/createError.js"
                    );
                    var defaults = __webpack_require__(
                        /*! ../defaults */ "./lib/defaults.js"
                    );
                    var Cancel = __webpack_require__(
                        /*! ../cancel/Cancel */ "./lib/cancel/Cancel.js"
                    );
  ...
  \**********************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    var bind = __webpack_require__(
                        /*! ./helpers/bind */ "./lib/helpers/bind.js"
                    );
                    var Axios = __webpack_require__(
                        /*! ./core/Axios */ "./lib/core/Axios.js"
                    );
                    var mergeConfig = __webpack_require__(
                        /*! ./core/mergeConfig */ "./lib/core/mergeConfig.js"
                    );
                    var defaults = __webpack_require__(
                        /*! ./defaults */ "./lib/defaults.js"
                    );
                    ...
                    axios.CancelToken = __webpack_require__(
                        /*! ./cancel/CancelToken */ "./lib/cancel/CancelToken.js"
                    );
                    axios.isCancel = __webpack_require__(
                        /*! ./cancel/isCancel */ "./lib/cancel/isCancel.js"
                    );
                    axios.VERSION = __webpack_require__(
                        /*! ./env/data */ "./lib/env/data.js"
                    ).version;
                    ...
                    axios.spread = __webpack_require__(
                        /*! ./helpers/spread */ "./lib/helpers/spread.js"
                    );

                    // Expose isAxiosError
                    axios.isAxiosError = __webpack_require__(
                        /*! ./helpers/isAxiosError */ "./lib/helpers/isAxiosError.js"
                    );
  ...
  \***********************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    CancelToken.prototype.subscribe = function subscribe(
                        listener
                    ) {
                        if (this.reason) {
  ...
  \***************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    var mergeConfig = __webpack_require__(
                        /*! ./mergeConfig */ "./lib/core/mergeConfig.js"
                    );
                    var validator = __webpack_require__(
                        /*! ../helpers/validator */ "./lib/helpers/validator.js"
                    );
  ...
  \***********************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    var isAbsoluteURL = __webpack_require__(
                        /*! ../helpers/isAbsoluteURL */ "./lib/helpers/isAbsoluteURL.js"
                    );
                    var combineURLs = __webpack_require__(
                        /*! ../helpers/combineURLs */ "./lib/helpers/combineURLs.js"
                    );
  ...
  \*********************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    var enhanceError = __webpack_require__(
                        /*! ./enhanceError */ "./lib/core/enhanceError.js"
                    );
  ...
  \*************************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    var transformData = __webpack_require__(
                        /*! ./transformData */ "./lib/core/transformData.js"
                    );
                    ...
                    module.exports = function mergeConfig(config1, config2) {
                        ...
                        utils.forEach(
                            ...
                            function computeConfigValue(prop) {
                                var merge =
                                    mergeMap[prop] || mergeDeepProperties;
  ...
  \****************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    var createError = __webpack_require__(
                        /*! ./createError */ "./lib/core/createError.js"
                    );
  ...
  \*************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    var normalizeHeaderName = __webpack_require__(
                        /*! ./helpers/normalizeHeaderName */ "./lib/helpers/normalizeHeaderName.js"
                    );
                    var enhanceError = __webpack_require__(
                        /*! ./core/enhanceError */ "./lib/core/enhanceError.js"
                    );
                    ...
                    function getDefaultAdapter() {
                        ...
                        if (typeof XMLHttpRequest !== "undefined") {
                            ...
                            adapter = __webpack_require__(
                                /*! ./adapters/xhr */ "./lib/adapters/xhr.js"
                            );
                        } else if (
                            ...
                            adapter = __webpack_require__(
                                /*! ./adapters/http */ "./lib/adapters/xhr.js"
                            );
                        }
                        return adapter;
                    }
